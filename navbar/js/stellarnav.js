...
(function($) {
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		var settings = $.extend( {
			...
			breakpoint: 890, // number in pixels to determine when the nav should turn mobile friendly
		...
		return this.each( function() {
			...
			if (settings.theme == 'light' || settings.theme == 'dark' || settings.theme == 'mytheme') {
...
var sticky = 53;//header.offsetTop;
