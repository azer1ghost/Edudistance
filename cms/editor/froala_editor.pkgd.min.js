...
! function(a) {
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
                ...
                if (b.win.getSelection) {
                    ...
                    if (h.getRangeAt && h.rangeCount) {
                        ...
                        for (var i = 0; i < h.rangeCount; ++i)
                            if (d = h.getRangeAt(i),
                                e = d.commonAncestorContainer, e && 1 != e.nodeType && (e = e.parentNode), e && "a" == e.nodeName.toLowerCase()) c.push(e);
                            else {
        ...
        function wa(c) {
            ...
            if (d.length > 0) {
                var e, f, g = J(),
                    h = c.which;
                1 == d.length ? (e = d[0],
                    f = e) : (e = b.el.querySelector(".fr-cell-fixed"), f = b.el.querySelector(".fr-cell-handler"));
                var i = K(f, g);
        ...
        function e() {
            if (!B) {
                ...
                B = f.$modal, f.$modal.addClass("fr-middle"), b.events.bindClick(g, "button.fr-remove-word", function() {
                    (B.data("instance") || b).wordPaste.clean()
                }), b.events.bindClick(g, "button.fr-keep-word", function() {
                    (B.data("instance") || b).wordPaste.clean(!0)
                }), b.events.$on(a(b.o_win), "resize", function() {
                    b.modals.resize(D)
                })
            }
        ...
        function g(a) {
            ...
            a || (b.opts.wordAllowedStyleProps = []), 0 === C.indexOf("<colgroup>") && (C = "<table>" + C + "</table>"), C = A(C, b.paste.getRtfClipboard());
            var d = b.doc.createElement("DIV");
            ...
            for (var d = a.split(c), e = 1; e < d.length; e++) {
                ...
                if (f = f.split("shplid"), f.length > 1) {
                    ...
                    if (k.length > 2 && -1 != k[0].indexOf("blipuid")) l = k[1].split(" ");
                        ...
                        if ((l = k[0].split(" ")) && l.length < 2) continue;
                        l.shift()
                    }
                    var m = l.join("");
                    E[b + g] = {
        ...
        function x(a, b) {
            var c = a.tagName,
                d = c.toLowerCase();
            if (a.firstElementChild && ("I" == a.firstElementChild.tagName ? n(a.firstElementChild, "em") : "B" == a.firstElementChild.tagName && n(a.firstElementChild, "strong")), -1 != ["SCRIPT", "APPLET", "EMBED", "NOFRAMES", "NOSCRIPT"].indexOf(c)) return h(a), !1;
            var e = -1,
                f = ["META", "LINK", "XML", "ST1:", "O:", "W:", "FONT"];
            for (e = 0; e < f.length; e++)
                if (-1 != c.indexOf(f[e])) return a.innerHTML ? (a.outerHTML = a.innerHTML, h(a), !1) : (h(a), !1);
            if ("TD" != c) {
                var g = a.getAttribute("class");
                if (b && g) {
                    g = q(g);
                    var i = g.split(" ");
                    for (e = 0; e < i.length; e++) {
                        var j = i[e],
                            k = [],
                            l = "." + j;
                        k.push(l), l = d + l, k.push(l);
                        for (var m = 0; m < k.length; m++) b[k[m]] && r(a, b[k[m]])
                    }
                    a.removeAttribute("class")
                }
                b && b[d] && r(a, b[d])
            }
            if (-1 != ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(c)) {
                var s = a.getAttribute("class");
                if (s && (b && b[c.toLowerCase() + "." + s] && r(a, b[c.toLowerCase() + "." + s]), -1 != s.toLowerCase().indexOf("mso"))) {
                    var t = q(s);
                    t = t.replace(/[0-9a-z-_]*mso[0-9a-z-_]*/gi, ""), t ? a.setAttribute("class", t) : a.removeAttribute("class")
                }
                var u = a.getAttribute("style");
                if (u) {
                    var v = u.match(/text-align:.+?[; "]{1,1}/gi);
            ...
            if ("TR" == c && o(a, b), "A" == c && !a.attributes.getNamedItem("href") && a.innerHTML && (a.outerHTML = a.innerHTML), "TD" != c && "TH" != c || a.innerHTML || (a.innerHTML = "<br>"), "TABLE" == c && (a.style.width = "100%"), a.getAttribute("lang") && a.removeAttribute("lang"), a.getAttribute("style") && -1 != a.getAttribute("style").toLowerCase().indexOf("mso")) {
                var w = q(a.getAttribute("style"));
                w = w.replace(/[0-9a-z-_]*mso[0-9a-z-_]*:.+?(;{1,1}|$)/gi, ""), w ? a.setAttribute("style", w) : a.removeAttribute("style")
            }
            return !0
        }
